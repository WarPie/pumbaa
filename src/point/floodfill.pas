{==============================================================================]
  @action:: Outputs Flood Filled points from TPA or non-TPA points inside an area,
            ...
            scan parameter accepts: sd4Ways (4-way FloodFill) and sd8Ways (8-way FloodFill)
...
[==============================================================================}
procedure TPAFloodFillEx(TPA: TPointArray; start: TPoint; scan: TScanDirections; area: TBox; var output: TPointArray); callconv
...
procedure TPAFloodFill(TPA: TPointArray; start: TPoint; scan: TScanDirections; var output: TPointArray); callconv
var
  i, l: Integer;
  b: TBox;
begin
  ...
  begin
    ...
    TPAFloodFillEx(TPA, start, scan, b, output);
  end else
    SetLength(output, 0);
end;
